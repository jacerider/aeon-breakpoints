...
aeonBreakpoints.read = function (path) {
...
aeonBreakpoints.write = function (path) {
  let scssFile = fs.createWriteStream(path)
  return scssFile
}

aeonBreakpoints.ymlToScss = function () {
...
module.exports = aeonBreakpoints
